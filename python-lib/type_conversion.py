...
class TypeConversion(object):
    ...
    def __init__(self, config, export_geometry_as_string=False):
        ...
        self.mapping_dss_to_hyper = {
            ...
            'geometry': (SqlType.text(), handle_null(str)) if export_geometry_as_string else (SqlType.tabgeography(), handle_null(to_hyper_geography)),
            'geopoint': (SqlType.tabgeography(), handle_null(to_hyper_geography)),
        ...
        self.mapping_hyper_to_dss = {
            ...
            TypeTag.TABGEOGRAPHY: ('geopoint', handle_null(to_dss_geopoint)),
